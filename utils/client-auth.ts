...
// Let each function invoke the client in scope & make sure we have the proper authorization scopes to get the data we need to display
...
// This is a utility function to make fetching protected endpoints easier by generating a token from Auth0 and passing it into the request
